...
export default class Bingo {
  ...
  static save() {
    ...
    // save cards that are done to localstorage
    let cardsWon = [];
    let cards = document.querySelectorAll(".bingo__card--done");
    // push cards into cardsWon
    ...
    if (localStorage.getItem("bingo")) {
      ...
      // .bingo__card--done
        ...
        for (let i=0; i<cardsWon.length; i++) {
            document.querySelector(`.bingo__card[data-number="${cardsWon[i]}"]`).classList.add("bingo__card--done");
        }
